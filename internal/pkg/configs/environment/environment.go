...
import (
	...
	"github.com/hgtpcastro/go-expert-lab-o11y-otel/internal/pkg/constants"
...
func ConfigAppEnv(environments ...Environment) Environment {
	...
	// `executing working directory` in our app for example `zipcodeservice`
...
func setRootWorkingDirectoryEnvironment() {
	...
	// when we `Set` a viper with string value, we should get it from viper with
	// `viper.GetString`, elsewhere we get empty string
